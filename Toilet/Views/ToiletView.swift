                        ...
                        if toiletDataManager.isLoading {
                            ...
                            if locationManager.isLocating {
                                ...
                                if nearbyLocations.isEmpty {
                                    ...
                                    .background(Color.clear)  // 列表背景改為白色
                                    .onAppear {
...
struct LocationRowView: View {
    ...
    var body: some View {
        HStack(spacing: 16) {
            ...
            HStack(spacing: 8) {
                // 距離
                Text(ToiletView.formatDistance(distance))
                ...
                VStack(spacing: 24) {
                    ...
                    Button(action: openLanguageSettings) {
                        HStack(spacing: 16) {
                            ...
                            VStack(alignment: .leading, spacing: 4) {
                                Text(LocalizedStrings.language.localized)
                                    .font(.bodyRounded(.semibold))
                                    .foregroundColor(.primary)
                                Text(LocalizedStrings.languageSettingDetail.localized)
                                    .font(.captionRounded())
                                    .foregroundColor(.secondary)
                            }
