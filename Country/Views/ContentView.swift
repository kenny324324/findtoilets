...
struct ContentView: View {
    ...
    var body: some View {
        ZStack(alignment: .topLeading) {
            // 地圖視圖
            MapView(region: $region, mapType: mapType, userLocation: locationManager.location, toilets: mapToilets, locations: toiletDataManager.locations, shouldJumpToLocation: $shouldJumpToLocation, onRegionChanged: { newRegion in
                ...
                VStack {
                    ...
                    HStack {
                        ...
                        HStack(spacing: 8) {
                            ...
                            Text(LocalizedStrings.loadingToilets.localized)
                                .font(.captionRounded())
                                .foregroundColor(.blue)
                        }
        ...
        .sheet(isPresented: $sheetPresented) {
            CountryView(sheetPresented: $sheetPresented, selectedDetent: $selectedDetent, locationManager: locationManager, mapToilets: $mapToilets, selectedToiletFromMap: $selectedToilet, selectedLocationFromMap: $selectedLocation)
